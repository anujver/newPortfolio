    ...
    <>
      ...
      <div className="h-auto sm:h-[250px] w-full sm:w-[900px] bg-stone-900 p-4 flex flex-col sm:flex-row justify-between items-center sm:items-start ml-[250px]">
        <div className="flex flex-col w-full sm:w-[650px] gap-4">
          <div className="flex flex-wrap gap-4 sm:gap-x-2">
            <div className="flex flex-col bg-stone-950 text-white p-2 rounded shadow-md h-[67px] w-full sm:w-[130px]">
              <button className="bg-transparent text-gray-400 px-2 text-sm text-left pl-2 text-ms">
                Total
              </button>
            ...
            <div className="flex flex-col bg-stone-950 text-white p-2 rounded shadow-md h-[67px] w-full sm:w-[130px]">
              <button className="bg-transparent text-gray-300 px-2 text-sm text-left pl-2 text-ms">
                Utilized
              </button>
              <p className="mt-1 text-ms text-left pl-2 text-teal-400 font-bold">
                24,569
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-4 sm:gap-x-2">
            <div className="flex flex-col bg-stone-950 text-white p-2 rounded shadow-md h-[67px] w-full sm:w-[130px]">
              ...
              <p className="mt-1 text-ms text-left pl-2 text-yellow-400 font-bold">
                21,120
              </p>
            </div>

            <div className="flex flex-col bg-stone-950 text-white p-2 rounded shadow-md h-[67px] w-full sm:w-[130px]">
              <button className="bg-transparent px-2 text-sm text-left pl-2 text-ms text-gray-300">
                Damaged
              </button>
              <p className="mt-1 text-ms text-left pl-2 text-pink-600 font-bold">
                569
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center bg-stone-950 text-white p-2 rounded shadow-md h-[60px] w-full sm:w-[270px]">
            <p className="text-ms pl-2 w-[90%] truncate text-gray-300">
              Categories: 56
            </p>
        ...
        <div className="bg-stone-950 text-white p-4 rounded shadow-md h-auto sm:h-[220px] w-full sm:w-[1000px] mt-4 sm:mt-0">
          <h6 className="font-bold mb-2 text-xl text-slate-300">
            Expense Monitor
          </h6>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-x-8">
            ...
            <div>
              <p className="text-ms mt-4 sm:mt-0 text-gray-400">
                Unpaid Payments:
              </p>
      ...
      <div className="flex w-[1200px] ">
        <div className="flex flex-col lg:flex-row gap-4 w-full justify-center items-start ml-[250px]">
          ...
          <div className="h-[300px] w-full sm:w-[550px] lg:w-[550px] bg-stone-900 text-white p-2 space-y-4 mx-auto mt-[20px]">
            <h3 className="text-ms font-bold">Orders</h3>
                ...
                .map((_, index) => (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <button className="px-3 py-1 rounded text-sky-500 border-2 border-sky-500 ml-4 mt-2 sm:mt-0">
                        Details
                      </button>
                    </div>
                  </div>
